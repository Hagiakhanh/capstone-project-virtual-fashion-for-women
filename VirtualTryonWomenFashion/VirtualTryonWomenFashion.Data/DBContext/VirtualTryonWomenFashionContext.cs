 ...
 */
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AiconversationId).HasName("PK__AIConver__6604C7D2345B7675");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD7978D51C018");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BDF4EA011");
        ...
        {
            entity.HasKey(e => e.CharacteristicId).HasName("PK__Characte__C0EA4DAFBA02B7FE");
        ...
        {
            entity.HasKey(e => e.ColorId).HasName("PK__Color__8DA7676D3C0473A7");

            entity.ToTable("Color");

            entity.HasIndex(e => e.ColorPrefix, "UQ__Color__4DAF32399B057DDB").IsUnique();
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Messages__C87C037CC365FA41");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32ECF6965C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF29329CFD");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CEF46E188");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED5D653381");

            entity.HasIndex(e => e.ProductSlug, "UQ__Products__A8918E70744FAC38").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProductColorId).HasName("PK__ProductC__C5DB681E3932FAEA");
        ...
        {
            entity.HasKey(e => e.ProductImageId).HasName("PK__ProductI__07B2B1D8719DE7B2");
        ...
        {
            entity.HasKey(e => e.ProductVariantId).HasName("PK__ProductV__E4D667255B107DBF");
        ...
        {
            entity.HasKey(e => e.RatingId).HasName("PK__Ratings__FCCDF85CC821CF5A");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AA4C87D9C");
        ...
        {
            entity.HasKey(e => e.CampaignId).HasName("PK__SaleCamp__3F5E8D79432B8197");
        ...
        {
            entity.HasKey(e => e.SizeId).HasName("PK__Size__83BD095A409233A1");
        ...
        {
            entity.HasKey(e => e.StatusLogId).HasName("PK__StatusLo__A1B4D0BDAB1370D6");
        ...
        {
            entity.HasKey(e => e.SuggestedOutfitId).HasName("PK__Suggeste__30483410A73F1D83");
            ...
            entity.HasMany(d => d.ProductVariants).WithMany(p => p.SuggestedOutfits)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("SuggestedOutfitId", "ProductVariantId").HasName("PK__OutfitVa__7E0552626C5E7344");
        ...
        {
            entity.HasKey(e => e.TicketChatId).HasName("PK__TicketCh__F9115A613CAF0F03");

            entity.HasIndex(e => e.Slug, "UQ__TicketCh__BC7B5FB640C9418C").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4B9AADCA06");
        ...
        {
            entity.HasKey(e => e.TryOnSlotId).HasName("PK__TryOnSlo__9581D25ED69CC537");
            ...
            entity.HasMany(d => d.ProductColors).WithMany(p => p.TryOnSlots)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("TryOnSlotId", "ProductColorId").HasName("PK__TryOnVar__69DC64DF618B14C0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC32C4A879");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105346AA69F7B").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserInteractionId).HasName("PK__UserInte__2CD47CC59B326B55");
        ...
        {
            entity.HasKey(e => e.WishlistId).HasName("PK__Wishlist__233189CBAAEE4943");
