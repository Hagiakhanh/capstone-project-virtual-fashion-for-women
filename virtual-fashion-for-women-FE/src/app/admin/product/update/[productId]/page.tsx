            ...
            if (productData && productData.productId) {
                ...
                if (prod.productColors && prod.productColors.length > 0) {
                    const mappedColors = prod.productColors.map((pc: ProductColor) => {
                        // Lấy tất cả images từ các variants
                        ...
                        return {
                            ...
                            // Không cần các field này nữa vì đã có colorId
                            colorName: '',
                            colorPrefix: '',
                            hexCode: '',
                        };
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            {mainImagePreview && (
                                <img src={mainImagePreview} alt="Preview" className="w-32 h-32 object-cover mb-2 rounded" />
                            )}
                            <input
                                type="file"
                                accept="image/*"
                        ...
                        <div key={colorIndex} className="border p-4 mb-4 rounded">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    {pc.noBgImgPreview && (
                                        <img src={pc.noBgImgPreview} alt="Preview" className="w-32 h-32 object-cover mb-2 rounded" />
                                    )}
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                <div>
                                    ...
                                    {pc.productVariantImagePreviews && pc.productVariantImagePreviews.length > 0 && (
                                        <div className="flex gap-2 mb-2 flex-wrap">
                                            {pc.productVariantImagePreviews.map((url: string, idx: number) => (
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <div className="col-span-2">
                                                    ...
                                                    {variant.imagePreview && (
                                                        <img src={variant.imagePreview} alt="Preview" className="w-20 h-20 object-cover mb-1 rounded" />
                                                    )}
                                                    <input
                                                        type="file"
                                                        accept="image/*"
