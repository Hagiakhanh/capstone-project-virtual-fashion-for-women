            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate("productWeight", parseFloat(e.target.value))}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate("productLength", parseFloat(e.target.value))}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate("productWidth", parseFloat(e.target.value))}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onUpdate("productHeight", parseFloat(e.target.value))}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                </div>
