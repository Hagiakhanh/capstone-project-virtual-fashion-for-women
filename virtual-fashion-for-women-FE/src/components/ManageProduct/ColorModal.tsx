        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-lg shadow-2xl p-6 w-full max-w-md relative z-50">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 text-white px-4 py-2.5 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mt-6 font-medium cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Xong
                </button>
            </div>
